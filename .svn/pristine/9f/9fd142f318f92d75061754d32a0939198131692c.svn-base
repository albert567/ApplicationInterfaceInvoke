...
function findInfo() {
    ...
    $('#dg').datagrid({
				...
				queryParams: {
			        ...
			        "invokeAppName":sApp,
			        "invokeInterName":sInter,
			        "invokeMeName":sMethod,
...
function edit(index) {
    ...
    $('#cmbMethod2').combobox("clear")
    $('#cmbMethod2').combobox('loadData', []);
    var url2 = '../method/getMethodName?InterfaceID=' + sele.interID;
    $('#cmbMethod2').combobox('reload', url2);


    $('#cmbInvokeInter2').combobox("clear")
    $('#cmbInvokeInter2').combobox('loadData', []);
    var url3 = '../appInter/GetInterName?ApplicationID=' + sele.invokeAppID;
    $('#cmbInvokeInter2').combobox('reload', url3);

    $('#cmbInvokeMethod2').combobox("clear")
    $('#cmbInvokeMethod2').combobox('loadData', []);
    var url4 = '../method/getMethodName?InterfaceID=' + sele.invokeInterID;
...
function removeit(index) {
	...
	$.messager.confirm('确认', '您确认要删除['+sele.invokeAppName+']应用['+sele.invokeInterName+']接口[' + sele.invokeMeName + ']方法吗？', function(r) {
				if (r) {
