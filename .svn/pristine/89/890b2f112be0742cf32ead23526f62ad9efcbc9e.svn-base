      (function ($) {
          ...
          $.fn.autoComplete = function (config) {
              ...
              var defaults = {
                  width: 300, //提示框的宽度 
                  maxheight: 500, //提示框的最大高度
                  top: 6,  //与文本框的上下距离
                  url: "",   //ajax 请求地址
                  type: "post", //ajax 请求类型
                  async: false,  //是否异步请求
                  autoLength: 1,  //文本长度大于0 就请求服务器
              ...
              var p = c.position();
              d = $('<div id="' + c.attr("id") + 'autoComplete_Group" class="autoComplete_Group" value="123"></div>');
              c.after(d);
          ...
          function blur_process(e) {
              if (e.target == d || e.target == c) {
                  return;
              }
