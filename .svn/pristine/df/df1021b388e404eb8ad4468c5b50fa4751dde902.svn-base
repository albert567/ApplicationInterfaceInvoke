...
if(opts.multiple)file.attr("multiple","multiple");
...
$.fn.filebox.defaults=$.extend({},$.fn.textbox.defaults,{multiple:false,buttonIcon:null,buttonText:"Choose File",buttonAlign:"right",inputEvents:{}});
})(jQuery);
(function($){
function _506(_507){
...
var row=opts.finder.getRow(_638,_63a);
opts.onMouseOutRow.call(_638,_63a,row);
}
};
};
function _63d(e){
...
opts.onMouseOverRow.call(_6b3,_6b4,row);
...
},onMouseOverRow:function(_7e6,_7e7){
},onMouseOutRow:function(_7e6,_7e7){
